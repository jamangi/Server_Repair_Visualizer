...
| **PDB** | **Power Distribution Board**. | Confirmed | Small tray assembly just behind or beside the fan row toward machine-left/center, adjacent to the BMC board. |
...
| **V** | **volt**; **12 V** means twelve volts. | Confirmed unit | The paired 12 V inner busbars and associated busbar power hardware run through the middle/rear power-delivery area. |
